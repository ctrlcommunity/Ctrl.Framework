...
namespace Ctrl.Core.EntityFrameworkCore.EntityFrameworkCore
{
    public static class CtrlDbContextModelCreatingExtensions
    {
        public static void ConfigureCtrl(this ModelBuilder builder)
        {
            ...
            //init Data
            builder.Entity<SystemUser>().HasData(new SystemUser(SimpleGuidGenerator.Instance.Create(), "admin", "admin", "S0JRR96eei0=", null, null, null, null, "系统管理员", true, DateTime.Now, false, @"/Files/2019/04/04-29/d9a7bd7d-030d-4a74-b6f2-6bb31cf9b10a.png"));
            ...
            builder.Entity<SystemMenuButton>().HasData(
                ...
                new SystemMenuButton(id: SimpleGuidGenerator.Instance.Create(), menuId: Guid.Parse("d19e918c-0694-437e-b604-b989a5668695"), name: "数据分析", icon: "fas fa-chart-pie", script: "btn_data_box()", orderNo: 0, remark: null, createTime: DateTime.Now, code: null),
