    ...
    public static class CtrlDbContextModelCreatingExtensions
    {
        public static void ConfigureCtrl(this ModelBuilder builder)
        {
            ...
            builder.Entity<SystemMenu>().HasData(
                ...
                new SystemMenu(menuId: Guid.Parse("8ba0133b-3c19-4bca-a86d-527463ff4fd3"), parentId: Guid.Parse("9d804188-dded-418f-99c4-c9ee145673fb"), code: "", name: "操作日志", openType: null, icon: "fas fa-eye", area: "SysManage", controller: "Log", action: "OperationLog", openUrl: "/SysManage/Log/OperationLog", remark: null, orderNo: 0, canbeDelete: false, isFreeze: false, isShowMenu: true),
