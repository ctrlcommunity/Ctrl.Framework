    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("38b08da7-6d50-4fdf-ac8a-d11ca05941cc"), null, new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5705), "fas fa-edit", new Guid("93967f84-2598-4aca-9a50-5c4a7719820f"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("f7440017-337e-4a68-9edd-14b478b59f0c"), null, new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5715), "fas fa-plus", new Guid("e0d226e9-6253-42c7-abbd-65111f73d406"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("78bb4ba6-9de5-4def-aadf-46de47f51b3d"), "xtgl-wz-SaveArticle", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5730), "fas fa-plus", new Guid("e0d226e9-6253-42c7-abbd-65111f73d406"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("00773067-437f-4a23-a87b-15a6d32574d3"), "xtgl-mkwh-DeleteMenu", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5742), "far fa-trash-alt", new Guid("fc239bef-8bfa-48a4-ad99-150a1b1a017e"), "删除", 0, null, "btn_edit_box()" },
                    { new Guid("27eca2c0-c172-416a-b4de-cc15a943adaa"), "ljgl-ljlx-SaveSystemLinkType", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5785), "fas fa-plus", new Guid("271fade9-0e28-411b-ad92-7fc9a3b57990"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("d07dfe90-ba40-4725-b334-566a3f4c88f3"), "xtgl-cdan-SaveMenuButton", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5765), "fas fa-edit", new Guid("8f9d406f-70f0-4a11-9380-616fe2395c9e"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("49d8de58-364c-41c5-88c2-cb161870976a"), "xtgl-zdgl-SaveSystemDictionary", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5775), "fas fa-edit", new Guid("af66d9a6-3567-4267-a7cc-a79982b53fd0"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("5e7bb3b6-70a0-4d92-8127-425a80c71a71"), "xtgl-wzlx-SaveArticleType", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5694), "fas fa-plus", new Guid("93967f84-2598-4aca-9a50-5c4a7719820f"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("465f4755-6cb0-49ad-8109-18fc7568738e"), "xtgl-zdgl-SaveSystemDictionary", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5754), "fas fa-plus", new Guid("af66d9a6-3567-4267-a7cc-a79982b53fd0"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("1c47ce2e-f2c7-4bce-80ba-d926a885c207"), "xtgl-zffs-SavePays", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5681), "fas fa-plus", new Guid("8f9d406f-70f0-4a11-9380-616fe2395c9e"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("14ed1348-0793-4c18-8781-c75fd85e8e0b"), "wzgl-wzlb-Delete", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5806), "fas fa-trash-alt", new Guid("e0d226e9-6253-42c7-abbd-65111f73d406"), "删除", 0, null, "btn_delete_box()" },
                    { new Guid("6054574b-9ad6-4f47-868c-84bd8a9abbb1"), "xtgl-mkwh-SaveMenu", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5659), "fas fa-edit", new Guid("fc239bef-8bfa-48a4-ad99-150a1b1a017e"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("30a8e873-1a14-43e8-8aef-af86441a984b"), "xtgl-mkwh-SaveMenu", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5647), "fas fa-plus", new Guid("fc239bef-8bfa-48a4-ad99-150a1b1a017e"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("43ad2588-4bfb-4463-9b7e-1e92e211f41c"), "xtgl-xtyh-SaveUser", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5637), "fas fa-plus", new Guid("004e1aeb-5270-42cf-945c-dd7a1f277ced"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("2550bdae-2c09-4f7b-b658-f3ed0b48a39d"), "xtgl-jswh-SaveRole", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5613), "fas fa-plus", new Guid("40793482-245c-4a1c-8c58-351b6d1b2e7f"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("5fe76e91-9e61-4823-8b6b-5bbdc36a92fc"), "xtgl-jswh-ChosenButton", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5601), "fas fa-user-minus", new Guid("40793482-245c-4a1c-8c58-351b6d1b2e7f"), "按钮权限", 0, null, "buttonPermission()" },
                    { new Guid("a2667ffe-7911-4f87-94b7-61c379620c0e"), "xtgl-jswh-Chosen", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5588), "fas fa-user-lock", new Guid("40793482-245c-4a1c-8c58-351b6d1b2e7f"), "模块权限", 0, null, "menuPermission()" },
                    { new Guid("b2217d51-666a-455a-9946-e39231fb567d"), null, new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5402), "fas fa-edit", new Guid("6a1969b8-31ee-4bd7-9ca4-4375ddceba73"), "编辑", 0, null, "btn_edit_box()" },
                    { new Guid("ea0c6981-23a3-4725-8f22-9cda4662496f"), "xtgl-cdan-SaveMenuButton", new DateTime(2020, 3, 7, 20, 23, 11, 442, DateTimeKind.Local).AddTicks(7671), "fas fa-plus", new Guid("6a1969b8-31ee-4bd7-9ca4-4375ddceba73"), "新增", 0, null, "btn_add_box()" },
                    { new Guid("feca74e6-2d77-4d2e-b290-43ef8be6e7eb"), "ljgl-ljlx-SaveSystemLinkType", new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5796), "fas fa-edit", new Guid("271fade9-0e28-411b-ad92-7fc9a3b57990"), "编辑", 0, null, "btn_add_box()" },
                    { new Guid("5cd7d37f-73ff-443b-8c59-e6423343e36b"), null, new DateTime(2020, 3, 7, 20, 23, 11, 443, DateTimeKind.Local).AddTicks(5670), "fas fa-chart-pie", new Guid("d19e918c-0694-437e-b604-b989a5668695"), "数据分析", 0, null, "btn_data_box()" }
                });

            migrationBuilder.InsertData(
                table: "Sys_User",
                columns: new[] { "Id", "Code", "CreateTime", "Email", "FirstVisitTime", "ImgUrl", "IsAdmin", "IsFreeze", "LastVisitTime", "Mobile", "Name", "Password", "Remark" },
                values: new object[] { new Guid("da906042-dc9b-4ad4-a54b-7ff4b2281091"), "admin", new DateTime(2020, 3, 7, 20, 23, 11, 437, DateTimeKind.Local).AddTicks(1785), null, null, "/Files/2019/04/04-29/d9a7bd7d-030d-4a74-b6f2-6bb31cf9b10a.png", true, false, null, null, "admin", "S0JRR96eei0=", "系统管理员" });
        }
