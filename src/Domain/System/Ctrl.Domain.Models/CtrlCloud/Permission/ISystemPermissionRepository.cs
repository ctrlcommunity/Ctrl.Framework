...
namespace Ctrl.System.DataAccess
{
    ...
    ///     权限记录表数据访问接口
    /// </summary>
    public interface ISystemPermissionDapperRepository : IDapperRepository
    {
        ///<summary>
        ///     根据权限归属id查询菜单权限信息
        ///</summary>      
        Task<IEnumerable<SystemPermissionDto>> GetPermissionByPrivilegeMasterValue(GetPermissionByPrivilegeMasterValueInput input);
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        Task<IEnumerable<HavePermisionDto>> GetHavePermisionByUserId(string userId);
        /// <summary>
        ///     根据用户id获取权限
        /// </summary>
        /// <param name="userId"></param>
